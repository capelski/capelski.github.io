            ...
            <div className="projects" style={projectsStyle}>
                ...
                >
                    <p>
                        ...
                        <Anchor url="https://capelski.github.io/daggout-admin/">back office</Anchor>{' '}
                        and an{' '}
                    ...
                    <p>
                        DAGGOUT SL was a startup I co-founded along with <b>Oscar Ortega</b> during
                        our residence in Demium startup incubator, aiming to digitize paper receipts
                        for the fashion industry. Expo/React Native for the mobile app and Google
                        Cloud Platform for the backend.
                    </p>
                </Project>
                ...
                <Project date="2012" image="desdecasa.png" repository="desdecasa" title="desdecasa">
                    <p>
                        ...
                        150 membership cards to the website users.
                    </p>
                    <p>
                ...
                >
                    <p>
                        ...
                        Play along using the metronome function or provide a Youtube URL and play
                        over the backing track.
                    </p>
                    <p>
                        I developed this web app to help me practice my guitar lessons, and learn
                        about rhythm patterns along the way. The tabs the user create are publicly
                        available, stored in a Firestore database. A couple of fun challenges I had
                        to address: considering the render time of the page when playing the backing
                        tracks and indexing the dynamic content generated by the users in the web
                        sitemap.
                    </p>
                </Project>
                ...
                >
                    <p>
                        I enjoy playing the Monopoly board game every now and then, but the box is
                        too big to bring it around with me. This web version can be played anytime
                        from anywhere. It also makes the games faster by adding a timeout for each
                        player turn.
                    </p>
                    <p>
                        I wanted the app to support multiplayer online games. I first implemented a
                        proper online version using web sockets, but I didn't want to keep a server
                        up and running. The WebRTC version allows peer to peer connections within
                        the same virtual network and no need for intermediary servers.
                    </p>
                </Project>
                ...
                >
                    <p>
                        ...
                        practice offline against the dealer or learn the Blackjack basic strategy.
                    </p>
                    <p>
                        After having developed a terrible Visual Basic desktop application in 2011
                        and failed to finish a Java command line utility in 2014, I decided to
                        redeem myself by building it in web flavour.
                    </p>
                </Project>
                ...
                >
                    <p>
                        ...
                        Filter them by text, share them with your friends and have them always
                    ...
                    <p>
                        ...
                        Simplified interface and brand new name (Jokify was already taken in Play
                        Store).
                    </p>
                </Project>
                ...
                >
                    <p>
                        Android app designed to learn the basic strategy for Blackjack card game.
                        Set the rules of your favorite casino and get ready to beat the dealer.
                    </p>
                    <p>
                        My Blackjack basic strategy still wasn't good enough after having developed{' '}
                        <b>webjack</b> so I decided to build another Blackjack app focusing solely
                        on that part. This time using Expo/React Native instead of vue.js and adding
                        a range of new features around basic strategy.
                    </p>
                </Project>
                ...
                >
                    <p>
                        Yet another web on Blackjack. This time, focused solely on probability and
                        statistics, to understand where the basic strategy comes from and how much
                        it contributes to maximize the player earnings.
                    </p>
                    <p>
                        After mastering the Blackjack basic strategy through <b>Blackjump</b>, I was
                        still not making money when playing Blackjack at the casinos. I built a
                        couple of web apps to see if the basic strategy could be improved in any
                        way. The predecessor to this one is{' '}
                ...
                >
                    <p>
                        ...
                        realistic vue.js app (using webpack and consuming data from a Web Api) and
                        walks through the process of getting it to render on the server side.
                    </p>
                    <p>
                        After attending many coding Meetup talks I felt I had to contribute back by
                        organizing my own. A friend of mine brought his 360º camera and recorded
                        part of the session (the camera's battery run out) which is now available on
                        YouTube.
                    </p>
                </Project>
                ...
                >
                    ...
                    <p>
                        ...
                        Barcelona marathon was inconvenient. Solution: This responsive website to
                        track the training progress from the phone.
                    </p>
                </Project>
                ...
                >
                    <p>
                        ...
                        a newspaper), but it is not bulletproof; it might fail to find the solution.
                    </p>
                    <p>
                ...
                <Project date="2013" image="dovic.png" repository="do-vic" title="d.o. vic">
                    <p>
                        ...
                        contact information, pictures of the establishment and allowed making
                        reservations.
                    </p>
                    <p>
