...
export const Portfolio: React.FC = () => (
    ...
    >
        ...
        <div className="projects">
            ...
            >
                <p>
                    WYSIWYG editor for guitar tabs. Browse existing tabs or create your own. Play
                    along using the metronome function or provide a Youtube URL and play over the
                    backing track.
                </p>
                <p>
                    I developed this web app to help me practice my guitar lessons, and learn about
                    rhythm patterns along the way. The tabs the user create are publicly available,
                    stored in a Firestore database. A couple of fun challenges I had to address:
                    considering the render time of the page when playing the backing tracks and
                    indexing the dynamic content generated by the users in the web sitemap.
                </p>
            </Project>
            ...
            >
                <p>
                    I enjoy playing the Monopoly board game every now and then, but the box is too
                    big to bring it around with me. This web version can be played anytime from
                    anywhere. It also makes the games faster by adding a timeout for each player
                    turn.
                </p>
                <p>
                    I wanted the app to support multiplayer online games. I first implemented a
                    proper online version using web sockets, but I didn't want to keep a server up
                    and running. The WebRTC version allows peer to peer connections within the same
                    virtual network and no need for intermediary servers.
                </p>
            </Project>
            ...
            >
                <p>
                    ...
                    statistics, to understand where the basic strategy comes from and how much it
                    contributes to maximize the player earnings.
                </p>
                <p>
                    After mastering the Blackjack basic strategy through <b>Blackjump</b>, I was
                    still not making money when playing Blackjack at the casinos. I built a couple
                    of web apps to see if the basic strategy could be improved in any way. The
                    predecessor to this one is{' '}
                    <Anchor url="https://capelski.github.io/blackjack-odds/">blackjack odds</Anchor>
                    .
                </p>
            </Project>
