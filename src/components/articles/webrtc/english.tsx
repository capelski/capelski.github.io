...
export const english: ArticleContent = {
    ...
    introduction: (
        <p>
            ...
            built-in functionalities and with no need for a communications server. That's AWESOME.
            But turns out that the browser API is complex, and I find the{' '}
    ...
    body: (
        <React.Fragment>
            ...
            <p>
                <i>
                    Note that the sample UI doesn't work on Firefox, since Firefox doesn't support{' '}
            ...
            <ul className="numbered">
                ...
                <li>
                    ...
                    <ArticleImage
                        ...
                        footer="Create data channels and/or stream tracks"
                    />
                </li>
                <li>
                    <p>
            ...
            <ul>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            data channel once the connection is established. It tells us the
                            channels are ready to start sending/receiving.
                        </li>
                        <li>
                ...
                <li>
                    ...
                    generated by the starting peer, received by the answering peer bia signaling
                    service.
            ...
            <p>
                ...
                the corresponding <InlineSnippet>RTCDataChannel</InlineSnippet> object. The incoming
                messages need to be handled through the <InlineSnippet>onmessage</InlineSnippet>{' '}
                handler (which we already defined earlier on).
            </p>
            ...
            <p>
                ...
                <InlineSnippet>close</InlineSnippet> event on the{' '}
                <InlineSnippet>RTCDataChannel</InlineSnippet> object in both peers.
            </p>
            ...
            <ul>
                <li>
                    ...
                    and returns a <InlineSnippet>RTCRtpSender</InlineSnippet> object, which can be
                    used to remove the track from the connection.
                </li>
                <li>
                    <InlineSnippet>removeTrack</InlineSnippet> removes a track from the connection
                    using the corresponding <InlineSnippet>RTCRtpSender</InlineSnippet> object.
                </li>
                <li>
                    Both <InlineSnippet>addTrack</InlineSnippet> and
                    <InlineSnippet>removeTrack</InlineSnippet> only work before establishing a
                    connection. They won't have any effect once the connection has been established.
                </li>
                <li>
                    Tracks trigger{' '}
                    ...
                    on neither of the peers. Unfortunately, peer A will not get notified when peer B
                    stops consuming peer A's tracks, neither when peer B stops peer B's own tracks.
                </li>
            </ul>
            ...
            <p>
                ...
                detect the change of the connection state. The same applies to media stream tracks
                and HTML video elements: they both need to be stopped explicitly.
            </p>
            ...
            <p>
                You are most likely trying to set the local description with an offer on a
                connection object that has already set it's remote description. Once the remote
                description has been set, the connection object can only create an answer.
            </p>
            <br />
            <BlockSnippet>
                ❌ Failed to execute 'setLocalDescription' on 'RTCPeerConnection': Failed to set
            ...
            <p>
                Most likely you have created an offer from a connection object before creating a
                data channel or adding a media stream track. Peer A must always add some media to
                the connection object (data chanel or stream tracks) BEFORE creating an offer and
